...
<title>eplay 코드 오류 대처 안내 : 네이버 카페</title>
...
<link rel="stylesheet"
	href="/static/css/main/css/line_sticker-1545208501000-9453.css"
	type="text/css">

<link rel="stylesheet"
	href="/static/css/main/css/comment-1558431787000-17199.css"
	type="text/css">

<link rel="stylesheet"
	href="/static/css/main/css/map/cafe_map-1545208501000-14563.css"
	type="text/css">
...
<link rel="stylesheet"
	href="/static/css/main/css/wide/1080_cafe-1562140615000-199511.css"
	type="text/css">

<link rel="stylesheet"
	href="/static/css/main/css/wide/1080_skin_white-1562140615000-20533.css"
	type="text/css">
...
<body class="">
	...
	<div id="main-area" class="skin-1080 fr">
		...
		<iframe name="cafe_main" id="cafe_main" title="카페 메인"
			src="//cafe.naver.com/ArticleRead.nhn?clubid=29723439&amp;page=1&amp;menuid=20&amp;boardtype=L&amp;articleid=1395&amp;referrerAllArticles=false"
			width="860" height="100%" frameborder="0" scrolling="no"
			marginwidth="0" marginheight="0" allowtransparency="true"
			onload="callPlugFloatingAdvert()" allowfullscreen=""
			style="height: 1726px;"></iframe>

		<script type="text/javascript">
			$("cafe_main").src = "//cafe.naver.com/ArticleRead.nhn?clubid=29723439&page=1&menuid=20&boardtype=L&articleid=1395&referrerAllArticles=false";
		</script>
		...
		<div id="plugFloatingBannerWrapper" class="content_banner_right"
			style="display: none;">
			<input type="hidden" name="plugFloatingBannerPvUrl"
				id="plugFloatingBannerPvUrl" value=""> <img
				id="plugFloatingBannerPv" style="display: none;"> <img
				id="plugFloatingBannerImp" style="display: none;">

			<div class="area">
				<div id="plugFloatingBannerDiv" class="box">
					<a class="link" target="_blank"> <img id="plugFloatingBanner"
						width="140" height="300" style="display: none;">
					</a>
					<button id="plugFloatingBannerCloseBtn" type="button"
						onclick="clickCloseFloatingAdvert();return false;"
						class="btn_banner_close" style="display: none;">
						<span class="blind">광고배너 닫기</span>
					</button>
				</div>
			</div>
		</div>
